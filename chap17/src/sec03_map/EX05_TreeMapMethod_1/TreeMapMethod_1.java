...
public class TreeMapMethod_1 {
	...
	public static void main(String[] args) {
		...
		//4. lastEntry()
		System.out.println(treeMap.lastEntry()); //20=20번째데이터
		...
		System.out.println(navigableSet.descendingSet());//[4,6,...,16,18]
		
		//16. NavigableMap<K, V> descendingMap()
		navigableMap = treeMap.descendingMap();
		System.out.println(navigableMap.toString());//18=18번째데이터 16=16, .. 4=4번째데이터
		System.out.println(navigableMap.descendingMap()); //4=4번째데이터 6=6, ... , 18=18번째데이터
	}
