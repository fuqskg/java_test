...
public class TreeSetMethod {
	...
	public static void main(String[] args) {
		...
		//3. lower(E element)
		System.out.println(treeSet.lower(26)); //35
		//4. higher(E element)
		...
		//9. SortedSe<E> headSet(E element)
		...
		//10. NavigableSet<E> geadSet(E element, boolean inclusive)
		...
		//13. SortedSet<E> subSeet(e element, E element)
		...
		//15. NavagableSet<E> descendingSet()
